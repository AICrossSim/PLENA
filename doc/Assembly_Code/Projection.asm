...
LOOP_NUM_HEAD:
    ...
    LOOP_TILE_VECTOR_IN_HEAD:
        ...
        H_PREFETCH_V x1, x12, csr_adr[8]; q_projected
        H_PREFETCH_V x2, x12, csr_adr[8]; cos
        V_MUL_VV x3, x1, x2;
        
        // sin[i : i + MLEN] * rotated_q[i : i + MLEN]
        H_PREFETCH_V x10, x13, csr_adr[9]; q_roped
        H_PREFETCH_V x1, x12, csr_adr[8]; rotated_q
        H_PREFETCH_V x2, x12, csr_adr[8]; sin
        V_MUL_VV x4, x1, x2;
        V_ADD_VV x1, x3, x4;
