...
def tokenize_glue(example, task_name, tokenizer, max_length=128):
    sentence1_key, sentence2_key = TASK_TO_KEYS[task_name]

    if sentence2_key is None:
        return tokenizer(example[sentence1_key], truncation=True, padding="max_length", max_length=max_length)
    else:
        return tokenizer(example[sentence1_key], example[sentence2_key], truncation=True, padding="max_length", max_length=max_length)
