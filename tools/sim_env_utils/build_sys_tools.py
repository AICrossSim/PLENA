...
def env_setup(memory_data_dict, build_path: str, data_config, quant_config, hbm_row_width=256, test_file_name=None):
    ...
    for type, value in memory_data_dict.items():
        if type == "mx":
            grp_blocks = value["blocks"]
            grp_bias = value["bias"]
