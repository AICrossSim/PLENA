...
static MATRIX_SRAM_TYPE: LazyLock<String> = LazyLock::new(|| matrix_sram_type());
static VECTOR_SRAM_TYPE: LazyLock<String> = LazyLock::new(|| vector_sram_type());
static MATRIX_SRAM_DATATYPE: LazyLock<MxDataType> = LazyLock::new(|| matrix_sram_datatype());
static VECTOR_SRAM_DATATYPE: LazyLock<MxDataType> = LazyLock::new(|| vector_sram_datatype());
...
async fn start() {
    ...
    let mram = Arc::new(MatrixSram::new_with_type(*MLEN, *MATRIX_SRAM_SIZE, *MATRIX_SRAM_DATATYPE, &*MATRIX_SRAM_TYPE)); // Matrix SRAM
    let vram = Arc::new(VectorSram::from_mx_type(*VLEN, *VECTOR_SRAM_SIZE, *VECTOR_SRAM_DATATYPE)); // Vector SRAM
