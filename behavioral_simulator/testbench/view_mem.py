...
if __name__ == "__main__":
    ...
    # print("\n" + "="*80)
    # print("Viewing MRAM dump first 4 rows (BF16 format)")
    # view_bin_file_by_row("../mram_dump.bin", exp_width=8, man_width=7, row_dim=64, num_bytes_per_val=2, start_row_idx=0, load_row_size=4)