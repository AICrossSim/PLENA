...
module coprocessor (
    ...
    logic hbm_prefetch_valid, hbm_prefetch_ready;
    ...
    hbm_data_scheduler #(
        ...
        .prefetch_data_ready(hbm_prefetch_ready),
        .prefetch_waddr     (prefetch_target_addr),
        ...
        .m_out_element      (fetched_m_element ),
        .m_out_scale        (fetched_m_scale),
        .m_out_data_wen     (),
