...
module tl_selector #(
    ...
    // Combinatorial logic, but cannot pass 1GHz DC
    // // Out Select
    ...
    //     if (rst) begin
    //         // Reset all outputs
    //         host_out_a_valid_o <= 1'b0;
    //         host_out_a_o       <= '0;
    //         host_out_b_ready_o <= 1'b0;
    //         host_out_c_valid_o <= 1'b0;
    //         host_out_c_o       <= '0;
    //         host_out_d_ready_o <= 1'b0;
    //         host_out_e_valid_o <= 1'b0;
    //         host_out_e_o       <= '0; 
    //         device_1_a_ready_o <= 1'b0;
    //         device_2_a_ready_o <= 1'b0;
    //         device_1_b_valid_o <= 1'b0;
    //         device_2_b_valid_o <= 1'b0;
    //         device_1_b_o       <= '0;
    //         device_2_b_o       <= '0;
    //         device_1_c_ready_o <= 1'b0;
    //         device_2_c_ready_o <= 1'b0;
    //         device_1_d_valid_o <= 1'b0;
    //         device_2_d_valid_o <= 1'b0;
    //         device_1_d_o       <= '0;
    //         device_2_d_o       <= '0;
    //         device_1_e_ready_o <= 1'b0;
    //         device_2_e_ready_o <= 1'b0;
    //     end else begin
    //         host_out_a_valid_o <= select ? device_2_a_valid_i : device_1_a_valid_i;
    //         host_out_a_o       <= select ? device_2_a_i : device_1_a_i;
    //         host_out_b_ready_o <= select ? device_2_b_ready_i : device_1_b_ready_i;

    //         host_out_c_valid_o <= select ? device_2_c_valid_i : device_1_c_valid_i;
    //         host_out_c_o       <= select ? device_2_c_i : device_1_c_i;
    //         host_out_d_ready_o <= select ? device_2_d_ready_i : device_1_d_ready_i;
    //         host_out_e_valid_o <= select ? device_2_e_valid_i : device_1_e_valid_i;
    //         host_out_e_o       <= select ? device_2_e_i : device_1_e_i;

    //         // Input Fill
    //         device_1_a_ready_o <= !select && host_out_a_ready_i;
    //         device_2_a_ready_o <= select  && host_out_a_ready_i;
    //         device_1_b_valid_o <= !select && host_out_b_valid_i;
    //         device_2_b_valid_o <= select  && host_out_b_valid_i;
    //         device_1_b_o       <= !select  ? host_out_b_i : '0;
    //         device_2_b_o       <= select   ? host_out_b_i : '0;
    //         device_1_c_ready_o <= !select && host_out_c_ready_i;
    //         device_2_c_ready_o <= select  && host_out_c_ready_i;
    //         device_1_d_valid_o <= !select && host_out_d_valid_i;
    //         device_2_d_valid_o <= select  && host_out_d_valid_i;
    //         device_1_d_o       <= !select  ? host_out_d_i : '0;
    //         device_2_d_o       <= select   ? host_out_d_i : '0;
    //         device_1_e_ready_o <= !select && host_out_e_ready_i;
    //         device_2_e_ready_o <= select  && host_out_e_ready_i;
    //     end
    // end
