...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+4,0,"count",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->pushPrefix("simple_counter", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBus(c+8,0,"count",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelfRef.count),2);
    bufp->fullBit(oldp+5,(vlSelfRef.simple_counter__DOT__clk));
    bufp->fullBit(oldp+6,(vlSelfRef.simple_counter__DOT__rst_n));
    bufp->fullBit(oldp+7,(vlSelfRef.simple_counter__DOT__en));
    bufp->fullCData(oldp+8,(vlSelfRef.simple_counter__DOT__count),2);
}
