...
// Result Buffering
logic [MLEN-1:0] [ACC_FP_EXP_WIDTH + ACC_FP_MANT_WIDTH : 0]   result_v;
...
systolic_mcu #(
    ...
    .v1_data_in_valid(stored_m_valid),
    .v1_data_in_ready(stored_m_ready),
    .v2_element(stored_v_element),
    .v2_scale(stored_v_scale),
    .v2_data_in_valid(stored_v_valid),
    .v2_data_in_ready(stored_v_ready),

    .v_result(result_element),
...
skid_buffer #(
    .DATA_WIDTH(MLEN * (ACC_FP_EXP_WIDTH + ACC_FP_MANT_WIDTH + 1))
) result_buffer (
    .clk(clk),
    .rst(rst),
