...
typedef enum logic [OPCODE_WIDTH - 1:0] {
    ...
    H_PREFETCH_V_H_C      = 6'h2A,
    H_PREFETCH_V_H_S      = 6'h2B,
    H_PREFETCH_V_L_C      = 6'h2C,
    H_PREFETCH_V_L_S      = 6'h2D,
    H_STORE_V_H_C         = 6'h2E,
    H_STORE_V_H_S         = 6'h2F,
    H_STORE_V_L_C         = 6'h30,
    H_STORE_V_L_S         = 6'h31,
    ...
    // CSR Setting
    C_SET_ADDR_REG        = 6'h32,
    C_SET_LUT             = 6'h33,
    C_SET_STRIDE_REG      = 6'h34,
    C_SET_SCALE_REG       = 6'h35
} CUSTOM_ISA_OPCODE;
