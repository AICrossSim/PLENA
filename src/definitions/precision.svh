...
package precision_pkg;
    ...
    parameter   WT_MXFP_MANT_WIDTH = 1;
    parameter   WT_MXFP_EXP_WIDTH = 2;
    parameter   MXFP_SCALE_WIDTH = 8;
    parameter   BLOCK_DIM = 4;
    parameter   V_FP_EXP_WIDTH = 3;
    parameter   V_FP_MANT_WIDTH = 4;
    parameter   M_FP_EXP_WIDTH = 7;
    parameter   M_FP_MANT_WIDTH = 8;
    parameter   S_FP_EXP_WIDTH  = V_FP_EXP_WIDTH;
    parameter   S_FP_MANT_WIDTH = V_FP_MANT_WIDTH;
    parameter   INT_DATA_WIDTH = 16;
