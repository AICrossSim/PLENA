...
class FPCPAccumulatorTB(Testbench):
    ...
    def generate_inputs(self, num):
        q_config = {
            ...
            "ADDER_CYCLES" : self.dut.ADDER_CYCLES.value,
        }
...
def test_simple_fp_addition():
    ...
    veri_runner(
        ...
        module_param_list=[
            {"EXP_WIDTH" : 6, "MANT_WIDTH" : 5, "ADDER_CYCLES" : 5},
        ],
        trace = True,
    )
