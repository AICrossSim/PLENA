...
module fp_reciprocal #(
    ...
    assign extend_exp = -(signed_exp_in - IN_FIX_FRAC_WIDTH) - leading_zeros; // for the int part, [sign, int, *frac]
    ...
    bit_width_aware_left_shift #(
        ...
        .in_data (unsigned_reciprocal_mantissa),
    ...
    assign signed_mant_out = (sign) ? -unsigned_mant_out: unsigned_mant_out;
