...
module fp_adder_tree #(
    ...
    localparam OUT_MAN_WIDTH = $clog2(VEC_DIM) * EXT_BITS_PER_LAYER + IN_MAN_WIDTH,    // TODO: 
    ...
    input  logic [VEC_DIM-1:0] [(IN_MAN_WIDTH + IN_EXP_WIDTH) : 0] data_in,
  ...
  generate
    if (LEVELS == 0) begin : gen_skip_adder_tree
      ...
      assign data_out = { ($clog2(VEC_DIM) * EXT_BITS_PER_LAYER)'b'(0), data_in[0]};
