...
module fp_exp #(
  ...
  localparam REG_N = 2; // 1 for data_reg here, 1 for taylor_series_expansion
...
module taylor_series_expansion #(
  ...
  logic [IN_WIDTH - 1:0] element_list_1_reg, element_list_2_reg, element_list_3_reg;
  ...
  assign fixed_tree_in[1] = element_list_1_reg;
  assign fixed_tree_in[2] = element_list_2_reg;
